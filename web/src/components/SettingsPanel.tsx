    ...
    <div className="settings-panel" data-testid="settings-panel">
      ...
      <section className="settings-section">
        ...
        <div className="danger-zone">
          <h4>⚠️ Danger Zone</h4>
          <p>
            Delete all local data permanently. This action cannot be undone.
          </p>
          <button
        ...
        <div className="setting-item">
          <label>
            <input
              type="checkbox"
              name="webrtc"
              checked={networkSettings.webrtc}
      ...
      {showDeleteDialog && (
        ...
        >
          ...
          >
            ...
            <p>
              This will <strong>permanently delete</strong> all your local data
              including:
            </p>
            <ul>
            ...
            <p className="warning-text">
              <strong>This action cannot be undone!</strong> Make sure you've
