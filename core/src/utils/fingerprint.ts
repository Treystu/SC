 ...
 */
export async function generateFingerprint(publicKey: Uint8Array | string): Promise<string> {
 ...
 */
export async function generateFullFingerprint(publicKey: Uint8Array | string): Promise<string> {
    let keyBytes: Uint8Array;
