...
class BLEConnectionManager(private val context: Context) {
    ...
    fun connect(
        ...
        connections[device.address] = ConnectionInfo(
    ...
    fun optimizeConnectionParameters(address: String): Boolean {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
            val priority = when (connection.getSignalQuality()) {
     ...
     * Request MTU change
     */
    fun requestMtu(address: String, mtu: Int = 185): Boolean {
        val connection = connections[address] ?: return false
     ...
     * Get connection info
     */
    fun getConnectionInfo(address: String): ConnectionInfo? {
     ...
     */
    private fun handleConnectionError(connection: ConnectionInfo, error: String) {
    ...
    fun getStats(): Map<String, Any> {
        ...
        return mapOf(
            ...
            "signalQuality" to allConnections.groupBy { it.getSignalQuality() }
