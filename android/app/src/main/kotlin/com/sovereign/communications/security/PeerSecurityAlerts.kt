...
class PeerSecurityAlertSystem(
    ...
    suspend fun createAlert(
        ...
        // Sign the alert using Keystore
        val signature = signAlert(contentJson.toByteArray(), reporterKeyAlias)
    ...
    suspend fun getPeerReputation(peerId: String): PeerReputation =
        reputationDao.getReputation(peerId) ?: PeerReputation(
            peerId = peerId,
     ...
     */
    private suspend fun updateReputationFromAlert(
        alert: SecurityAlert,
        impact: Int,
    ) {
    ...
    suspend fun revokeAlert(
        ...
        return createAlert(
            ...
            reporterId = reporterId,
            reporterKeyAlias = "identity_key", // Assuming the reporter uses their identity key
    ...
    /**
     * Sign alert using ECDSA via KeystoreManager
     */
    private fun signAlert(
        ...
        try {
            KeystoreManager.signData(keyAlias, data)
        } catch (e: Exception) {
    ...
    /**
     * Verify alert signature using ECDSA
     */
    private fun verifyAlertSignature(
        alert: SecurityAlert,
        ...
        try {
            ...
            // Verify signature
            KeystoreManager.verifyData(publicKey, data, alert.signature)
        } catch (e: Exception) {
...
object SecurityAlertHelpers {
    suspend fun createDeviceTheftAlert(
        ...
        alertSystem.createAlert(
            ...
            reporterId = reporterId,
            reporterKeyAlias = reporterKeyAlias,
