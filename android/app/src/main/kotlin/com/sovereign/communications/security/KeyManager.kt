...
class KeyManager(context: Context) {
    ...
    fun getIdentityKeyPair(): Sign.KeyPair {
        ...
        return if (privateKeyB64 != null && publicKeyB64 != null) {
            ...
            Sign.KeyPair(publicKey, privateKey)
        } else {
            generateAndStoreKeyPair()
        }
    }

    private fun generateAndStoreKeyPair(): Sign.KeyPair {
        val keyPair = sodium.cryptoSignKeypair()
        val privateKeyB64 = Base64.encodeToString(keyPair.secretKey, Base64.NO_WRAP)
    ...
    fun getPrivateKey(): ByteArray {
        return getIdentityKeyPair().secretKey
    }
}
